...
# Solution 3
#Yet another solution involves sorting the list. We can then iterate through the list and run a 
# #binary search on K - lst[i]. Since we run binary search on N elements, this would take 
